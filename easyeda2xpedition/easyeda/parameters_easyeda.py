...
from easyeda2xpedition.easyeda.svg_path_parser import parse_svg_path
...
class EeFootprintCopperArea(BaseModel):
    stroke_width: float
    layer_id: int
    net: str
    points: str
...
class EeFootprintSolidRegion(BaseModel):
    layer_id: int
    net: str
    points: str
    type: str
...
class ee_footprint:
    ...
    copper_areas: List[EeFootprintCopperArea] = field(default_factory=list)
