...
class EasyedaFootprintImporter:
    ...
    def extract_easyeda_data(
        ...
        for line in ee_data_str["shape"]:
            ...
            elif ee_designator == "COPPERAREA":
                ee_copper_area = EeFootprintCopperArea(
                    **dict(zip(EeFootprintCopperArea.__fields__, ee_fields))
                )
                new_ee_footprint.copper_areas.append(ee_copper_area)
            elif ee_designator == "SOLIDREGION":
                ee_solid_region = EeFootprintSolidRegion(
                    **dict(zip(EeFootprintSolidRegion.__fields__, ee_fields))
                )
                new_ee_footprint.solid_regions.append(ee_solid_region)
            else:
